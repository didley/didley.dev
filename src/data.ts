  ...
  projects: [
    {
      ...
      description: "A web based link sharing app. Users can create cards of 5 URLs, a preview is generated for each link and can then be posted to their profile.",
      images: [
    ...
    },
    {
      ...
      description: "A React Native app built in collaboration with another developer via GitHub. Users can track their garden creating progress logs for their plants.",
    ...
    },
    {
      ...
      description: "A web based calorie tracking app. When authenticated data is received via my API, when accessed as a guest the browsers session storage is used.",
      images: [
    ...
    },
    {
      ...
      description: "A web based life point tracking app. I’ve tested approaches in making the app feel more mobile native such as disabling text selection across the app and disabling browser UI when the app is installed.",
